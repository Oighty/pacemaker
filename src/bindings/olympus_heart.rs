...
pub mod olympus_heart {
    ...
    pub static OLYMPUSHEART_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static OLYMPUSHEART_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    #[ethcall(name = "withdrawUnspentRewards", abi = "withdrawUnspentRewards(address)")]
    ...
    impl ::ethers::core::abi::AbiDecode for OlympusHeartCalls {
        fn decode(
            ...
            if let Ok(decoded) = <WithdrawUnspentRewardsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
